...
CREATE TABLE IF NOT EXISTS receipts (
    ...
    category VARCHAR(100), -- office supplies, travel, meals, etc.
    description TEXT,
    ...
    submitted_by VARCHAR(255), -- employee or user who submitted
    approved_by VARCHAR(255), -- manager who approved
    approval_date DATE,
...
-- Create attachments table for storing file references (photos, PDFs, etc.)
...
-- Add attachment support to existing invoices table
...
-- Create receipt categories for easier classification
...
-- Insert common Swedish business expense categories
...
-- Create trigger to automatically update attachment counts
...
-- Create a view for easy receipt reporting
